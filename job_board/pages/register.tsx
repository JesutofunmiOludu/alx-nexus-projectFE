...
import { Briefcase, Mail, Lock, User, Zap } from 'lucide-react';
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">Join thousands of professionals and companies today.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-transparent bg-white"
                />
              </div>
              {errors.first_name && (
            ...
            {/* Primary Skill (for freelancers only) */}
            {userType === 'freelancer' && (
              <div>
                ...
                <div className="relative">
                  ...
                  <select className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-transparent bg-white appearance-none">
                    <option value="">Select your core expertise</option>
            ...
            >
              {isLoading ? (
                ...
                <>
                  Register as {userType === 'freelancer' ? 'Freelancer' : 'Employer'}
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-50 text-gray-500 uppercase tracking-wide">Or register with</span>
            </div>
          </div>
